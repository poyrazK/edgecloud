...
func TestRegisterWorker_TriggersRequestSync(t *testing.T) {
	...
	h := NewInternalHandler(nil, &fakeWorkerSvc{}, nil, nil, syncer, nil, "", "", "", middleware.WorkerJWTConfig{}, 0, "", "", nil)
...
func TestRegisterWorker_NilSyncer_DoesNotPanic(t *testing.T) {
	...
	h := NewInternalHandler(nil, &fakeWorkerSvc{}, nil, nil, nil, nil, "", "", "", middleware.WorkerJWTConfig{}, 0, "", "", nil)
...
func TestRegisterWorker_RegisterError_DoesNotTriggerSync(t *testing.T) {
	...
	h := NewInternalHandler(nil, worker, nil, nil, syncer, nil, "", "", "", middleware.WorkerJWTConfig{}, 0, "", "", nil)
